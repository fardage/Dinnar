...
export default function Privacy() {
	return (
		<>
			<Navbar />
			<Header title="Privacy Policy for DinnAR" />

			<div className="max-w-2xl mx-auto py-8 px-4 sm:py-12 sm:px-6 lg:max-w-7xl lg:px-8">
				<p>
					At DinnAR, accessible from https://dinnar.app/, one of our
					main priorities is the privacy of our visitors. This Privacy
					Policy document contains types of information that is
					collected and recorded by DinnAR and how we use it.
				</p>
				...
				<p>
					...
					information that they shared and/or collect in DinnAR. This
				...
				<h2 className="text-2xl font-extrabold tracking-tight text-gray-900 mb-2 mt-8">
					Consent
				</h2>
				...
				<p>
					DinnAR follows a standard procedure of using log files.
				...
				<p>
					...
					each of the advertising partners of DinnAR.
				</p>

				<p>
					Third-party ad servers or ad networks uses technologies like
					cookies, JavaScript, or Web Beacons that are used in their
					respective advertisements and links that appear on DinnAR,
				...
				<p>
					Note that DinnAR has no access to or control over these
				...
				<p>
					DinnAR&apos;s Privacy Policy does not apply to other
				...
				<p>
					DinnAR does not knowingly collect any Personal Identifiable
